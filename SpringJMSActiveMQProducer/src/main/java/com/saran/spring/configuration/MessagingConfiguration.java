...
import com.saran.spring.messaging.MessageReceiver;
...
public class MessagingConfiguration {
	...
	public ConnectionFactory connectionFactory(){
		...
		connectionFactory.setTrustedPackages(Arrays.asList("com.saran.spring"));
	...
	//convert java objects to jms messages
	@Bean 
